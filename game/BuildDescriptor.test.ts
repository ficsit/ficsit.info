...
describe(`schema.BuildDescriptor`, () => {
  it(`parses Desc_WalkwayCross_C from v116395`, () => {
    const result = BuildDescriptorSchema.parse({
      ...
      mSubCategories:
        '(BlueprintGeneratedClass\'"/Game/FactoryGame/Interface/UI/InGame/BuildMenu/BuildCategories/Sub_Organisation/SC_Walkways.SC_Walkways_C"\')',
    ...
    expect(result).toStrictEqual({
      ...
      mSubCategories: [
        new Reference(
          '/Game/FactoryGame/Interface/UI/InGame/BuildMenu/BuildCategories/Sub_Organisation/SC_Walkways.SC_Walkways_C',
