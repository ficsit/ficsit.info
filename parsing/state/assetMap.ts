...
export const assetMap: Record<string, string | undefined> = {
  ...
  CircuitBoard: 'Resource/Parts/CircuitBoard/UI/IconDesc_CircuitBoard',
  ...
  HyperPoleStackable: 'Buildable/Factory/HyperTubeWallSupport/UI/IconDesc_HyperTubeStackable',
